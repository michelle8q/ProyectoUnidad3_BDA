...
public class FrmAgregarGenero extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LblInicio.setText("Agregar genero");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAgregarGenero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAgregarGenero().setVisible(true);
            }
        });
    }
